              ...
              <ScrollReveal direction="left" delay={0.2}>
                <div className="bg-slate-50 p-10 border border-slate-200">
                  <form className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <label className="text-xs uppercase tracking-widest font-bold text-slate-400">Subject</label>
                      <select className="w-full bg-white border border-slate-200 p-4 focus:border-brand-blue outline-none transition-colors">
