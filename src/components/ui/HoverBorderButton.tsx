...
// Blue-Orange gradient on hover
const highlightBlue =
  'radial-gradient(75% 181.2% at 50% 50%, #1B49C2 0%, rgba(255, 255, 255, 0) 100%)';
const highlightOrange =
  'radial-gradient(75% 181.2% at 50% 50%, #FF7A00 0%, rgba(255, 255, 255, 0) 100%)';

interface HoverBorderButtonProps extends React.HTMLAttributes<HTMLElement> {
...
export function HoverBorderButton({
  ...
  const highlight = variant === 'orange' ? highlightOrange : highlightBlue;
