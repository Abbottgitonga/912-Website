  ...
  return (
    <ServiceLayout
      hero={{
        ...
        description: "Explore our specialized Cybersecurity capabilities, designed to scale with your business and deliver measurable ROI.",
        breadcrumbs: [
          { label: "Home", href: "/" },
      ...
      advantages={{
        title: "Why Choose Us?",
        items: [
          { title: "Domain Expertise", description: "Deep understanding of the specific requirements of Cybersecurity." },
